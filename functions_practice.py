...
def total_meal_price(meal, percentage = .15):
    total_paid = meal + (meal * percentage)
    return total_paid
...
#    greeting.
def write_letter(title, name, sender): 
        print "Dear " + full_title(title, name) + ", I think you are amazing! Sincerely, " + sender
